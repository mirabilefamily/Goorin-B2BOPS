...
shipments.unshift({ id: 'IS-0015', order: unpaidOrder, created: '2026-09-12', coo: false, stage: 3, incoterms: 'FOB', transport: 'Ocean', forwarder: 'FF 123', prepaidAt: '', paid: false, instructions: true });

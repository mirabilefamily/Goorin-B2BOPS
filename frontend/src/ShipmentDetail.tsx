        ...
        <div className="sh3-grid" data-testid="tab-panel-overview">
          <div className="sh-col">
            <section className="sh-card sh-checklist" data-testid="shipment-requirements">
              <header><div><h2>Booking & payment</h2><p>Both must be complete before the factory releases the shipment.</p></div><span className={`stat-chip ${reqDone === 2 ? 'stat-chip--good' : 'stat-chip--warn'}`} data-testid="req-progress">{reqDone === 2 ? <CheckCircle2 /> : <AlertCircle />} {reqDone} of 2 complete</span></header>
